...
class Metodos {
  ...
  public static final int direcoes[] = { 1, 5, 6, 3, 4, 7, 8, 2, 2, 7, 8, 3, 4, 5, 6, 1,
  ...
  public static void movimentoRandomico(Agente agente) {
    int direcao;
    do {
      direcao = (int)(Math.random() * 10); } while((direcao<1)||(direcao>8));
  ...
  public static int calculaDirecao(Agente agente, Posicao pos) {
    if(agente.coluna>pos.x) {
      if(agente.linha>pos.y) { return 5; }
      else if(agente.linha==pos.y) { return 3; }
	   else { return 7; } }
    else {
      if(agente.coluna==pos.x) {
	if(agente.linha>pos.y) { return 1; }
	else { return 2; } }
      else {
	if(agente.linha>pos.y) { return 6; }
	else if(agente.linha==pos.y) { return 4; }
	     else { return 8; } } } }
  ...
  public static int inverteDirecao(int direcao) {
    if(direcao==1) { return 2; }
    else if(direcao==2) { return 1; }
    else if(direcao==3) { return 4; }
    else if(direcao==4) { return 3; }
    else if(direcao==5) { return 8; }
    else if(direcao==6) { return 7; }
    else if(direcao==7) { return 6; }
    else if(direcao==8) { return 5; }
    return 9; }
  ...
  public static boolean taxaSucesso(Agente agente, int taxa) {
    if(agente.sucesso>=taxa) { return true; }
    else {return false; } }

  public static boolean atingeVidaAdulta(Agente agente, int tempo) {
    if(agente.tempovida>=tempo) { return true; }
    else { return false; } }
  ...
  public static boolean atingeTempoVida(Agente agente, int tempomax) {
    if(agente.tempovida<tempomax) { return false; }
    else { return true; } } }
