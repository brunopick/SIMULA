...
public class SIMULA extends Frame implements ActionListener, WindowListener,
			    ItemListener, KeyListener, MouseListener, AdjustmentListener {
      ...
      if((vetorIndex[num].cod == -1)) {
        ...
        if(!achou) {
          if(vetorIndex[num].param.equals("sucesso")) {
            if(!ac) vetorIndex[num].param="agente.sucesso";
            else vetorIndex[num].param="Executar.agentes[agente.ncriacao].sucesso";
            vetorIndex[num].cod=6;
            achou=true; } }
        if(!achou) {
          if(vetorIndex[num].param.equals("energia")) {
            if(!ac) vetorIndex[num].param="agente.energia";
            else vetorIndex[num].param="Executar.agentes[agente.ncriacao].energia";
            vetorIndex[num].cod=6;
            achou=true; } }
        if(!achou) {
          if(vetorIndex[num].param.equals("carga")) {
            if(!ac) vetorIndex[num].param="agente.carga";
            else vetorIndex[num].param="Executar.agentes[agente.ncriacao].carga";
            vetorIndex[num].cod=6;
            achou=true; } }
        if(!achou) {
...
/****************************************************************************/
  ...
  public void itemStateChanged(ItemEvent evt) {
    ...
    if(item == 0) { cor = Color.white; }
    else if(item == 1) { cor = Color.yellow; }
    else if(item == 2) { cor = Color.blue; }
    else if(item == 3) { cor = Color.green; }
    else if(item == 4) { cor = Color.orange; }
    else if(item == 5) { cor = Color.magenta; }
    else if(item == 6) { cor = Color.red; }
    else if(item == 7) { cor = Color.pink; }
    else if(item == 8) { cor = Color.cyan; }
    else if(item == 9) { cor = Color.gray; }
    else if(item == 10) { cor = Color.black; } }
