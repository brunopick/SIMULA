...
//            baseComportamentos.add( conButtonComp );
    ...
    public void criaDialogComportamentos( int ch, String strtmp )
    {
        ...
        if ( defDialogComportamentos == null )
        {
            ...
            compButtonDialogComp.setBounds( 396, 10, 90, 23 );
            ...
            agenteButtonDialogComp.setBounds( 396, 35, 90, 23 );
            ...
            varButtonDialogComp.setBounds( 396, 60, 90, 23 );
            ...
            operButtonDialogComp.setBounds( 396, 85, 90, 23 );
            ...
            paramButtonDialogComp.setBounds( 396, 110, 90, 23 );
...
//            operChoiceDialogComp.addItem( ">=" );
            ...
            operChoiceDialogComp.setBounds( 156, 85, 50, 23 );
            paramFieldDialogComp = new JTextField();
            paramFieldDialogComp.setBounds( 180, 110, 180, 23 );
            ...
            JLabel comportamentosLabel = new JLabel( "Utilização comportamentos:" );
            comportamentosLabel.setBounds( 20, 290, 150, 23 );
            baseDialogComportamentos.add( comportamentosLabel );
            JComboBox comportamentosComboBox = new JComboBox();
            comportamentosComboBox.setBounds( 20, 320, 310, 23 );
    ...
    public void criaDefVariaveis()
    {
        ...
        if ( defVariaveis == null )
        {
            ...
            nomeFieldVar.setBounds( 180, 50, 280, 23 );
            baseVariaveis.add( nomeFieldVar );
            tipoLabelVar = new JLabel( "Tipo da Variável:" );
            tipoLabelVar.setBounds( 40, 80, 120, 23 );
            ...
            tipoChoiceVar.setBounds( 180, 80, 100, 23 );
            valLabelVar = new JLabel( "Valor Inicial:" );
            valLabelVar.setBounds( 40, 110, 100, 23 );
            baseVariaveis.add( valLabelVar );
            valFieldVar = new JTextField( "" );
            valFieldVar.setBounds( 180, 110, 50, 23 );
...
//        baseAgentes.add( cargFieldAgent );
    ...
    public void criaDialogParada()
    {
        ...
        if ( defDialogParada == null )
        {
            ...
            varButtonDialogPar.setBounds( 396, 20, 90, 23 );
            ...
            operButtonDialogPar.setBounds( 396, 50, 90, 23 );
            ...
            paramButtonDialogPar.setBounds( 396, 80, 90, 23 );
            ...
            paramFieldDialogPar.setBounds( 180, 80, 180, 23 );
